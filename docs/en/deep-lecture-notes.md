...
3. Core concepts
4. Important definitions from the PPT / notes / textbook excerpts
5. Key mechanisms, processes, formulas, models, algorithms, diagrams, experiment steps, or case explanations
6. Exam-oriented explanations
7. Common question types
8. Mistake-prone points
9. Concept comparison tables
10. One-page quick review
...
3. Convert tables and diagrams into text explanations or review tables. Do not merely write "as shown in the figure".
...
Avoid overloading every sentence with labels. Use section openings, table columns, or highlighted blocks when appropriate.
...
The notes should be detailed, structured, and directly useful for university final-exam review. Prefer clear headings, compact tables, examples, step-by-step explanations, ready-to-memorize phrasing, and exam-oriented prompts. The output should preserve the informational value of the materials while making it clearer, not thinner or more generic.